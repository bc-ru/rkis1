...
/**
 * This class represents a Corvette
 */
public class Corvette extends Ship {
     ...
     * @param weight
     * @param capacity
     * @param medicalInsuranceCost
     * @param captainName
     */
    public Corvette(String name, String codeNumber, int yearMade, int weight, int capacity,
            int medicalInsuranceCost, String captainName) {

        super(name, codeNumber, yearMade, weight, capacity);
        this.captainName = captainName;
        this.numOfGuns = medicalInsuranceCost;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), this.numOfGuns, this.captainName);
    }
    ...
    public String toString() {
        return super.toString() + "captainName=" + captainName
                + ", medicalInsuranceCost=" + numOfGuns;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Corvette worker = (Corvette) obj;
        return numOfGuns == worker.numOfGuns && captainName.equals(
                worker.captainName);
    }

    /**
     * Returns a value of {@code medicalInsuranceCost} field of the class object
     * 
     * @return int {@code medicalInsuranceCost}
     */
    ...
    /**
     * Set {@code medicalInsuranceCost} field value to an class' obj
     * 
     * @param numOfGuns
     */
    public void setNumOfGuns(int numOfGuns) throws IllegalArgumentException {
        if (numOfGuns < 0) {
